...
import { dummyMigrants, dummyDoctors, dummyAppointments } from '../../../data/dummyData';
...
const AnalyticsPage: React.FC = () => {
    ...
    const appointmentStats = useMemo(() => {
        return dummyAppointments.reduce((acc, curr) => {
        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                <Card className="text-center">
                    ...
                    <p className="mt-2 text-3xl font-bold text-accent-cyan">{dummyMigrants.length}</p>
                </Card>
                 <Card className="text-center">
                    <h3 className="text-sm font-medium text-text-secondary">Total Doctors</h3>
                    <p className="mt-2 text-3xl font-bold text-accent-cyan">{dummyDoctors.length}</p>
                </Card>
                 <Card className="text-center">
                 ...
                 <Card className="text-center">
                    <h3 className="text-sm font-medium text-text-secondary">Completed This Month</h3>
